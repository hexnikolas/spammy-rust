...
impl KeyboardLayout {
    pub fn new() -> Self {
        let keys = vec![
            // ESC + F-keys row
            KeyInfo { code: 1, name: "ESC".to_string(), row: 0, col: 0, width: 2.0 },
            KeyInfo { code: 59, name: "F1".to_string(), row: 0, col: 1, width: 1.0 },
            KeyInfo { code: 60, name: "F2".to_string(), row: 0, col: 2, width: 1.0 },
            KeyInfo { code: 61, name: "F3".to_string(), row: 0, col: 3, width: 1.0 },
            KeyInfo { code: 62, name: "F4".to_string(), row: 0, col: 4, width: 1.0 },
            KeyInfo { code: 63, name: "F5".to_string(), row: 0, col: 5, width: 1.0 },
            KeyInfo { code: 64, name: "F6".to_string(), row: 0, col: 6, width: 1.0 },
            KeyInfo { code: 65, name: "F7".to_string(), row: 0, col: 7, width: 1.0 },
            KeyInfo { code: 66, name: "F8".to_string(), row: 0, col: 8, width: 1.0 },
            KeyInfo { code: 67, name: "F9".to_string(), row: 0, col: 9, width: 1.0 },
            KeyInfo { code: 68, name: "F10".to_string(), row: 0, col: 10, width: 1.0 },
            KeyInfo { code: 87, name: "F11".to_string(), row: 0, col: 11, width: 1.0 },
            KeyInfo { code: 88, name: "F12".to_string(), row: 0, col: 12, width: 1.0 },
            
            // Number row with backtick
            KeyInfo { code: 41, name: "`".to_string(), row: 1, col: 0, width: 1.0 },
            ...
            KeyInfo { code: 27, name: "]".to_string(), row: 2, col: 12, width: 0.8 },
            KeyInfo { code: 43, name: "\\".to_string(), row: 2, col: 13, width: 1.0 },
            
            // ASDF row
            KeyInfo { code: 58, name: "CAPS".to_string(), row: 3, col: 0, width: 1.5 },
            ...
            KeyInfo { code: 28, name: "ENTER".to_string(), row: 3, col: 12, width: 1.5 },
            
            // ZXCV row
            KeyInfo { code: 42, name: "SHIFT".to_string(), row: 4, col: 0, width: 2.1 },
            ...
            KeyInfo { code: 54, name: "SHIFT".to_string(), row: 4, col: 11, width: 2.0 },
            ...
            KeyInfo { code: 57, name: "SPACE".to_string(), row: 5, col: 3, width: 6.0 },
